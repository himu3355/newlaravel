                            ...
                            <div class="form-checkout mt-5">
                                <form>
                                    <div class="grid sm:grid-cols-2 gap-4 gap-y-5 flex-wrap">
                                        ...
                                        <div class="">
                                            <input class="border-line px-4 py-3 w-full rounded-lg" name="last_name" id="lastName" type="text" placeholder="Last Name *" required />
                                        </div>
                                        <div class="">
                                            <input class="border-line px-4 py-3 w-full rounded-lg" name="email" id="email" type="email" placeholder="Email Address *" required />
                                        </div>
                                        <div class="">
                                            <input class="border-line px-4 py-3 w-full rounded-lg" name="phone" id="phoneNumber" type="number" placeholder="Phone Numbers *" required />
                                        </div>
                                        ...
                                        <div class="">
                                            <input class="border-line px-4 py-3 w-full rounded-lg" name="city" id="city" type="text" placeholder="Town/City *" required />
                                        </div>
                                        <div class="">
                                            <input class="border-line px-4 py-3 w-full rounded-lg" name="address1" id="apartment" type="text" placeholder="Street,..." required />
                                        </div>
                                        ...
                                        <div class="">
                                            <input class="border-line px-4 py-3 w-full rounded-lg" name="post_code" id="postal" type="text" placeholder="Postal Code *" required />
                                        </div>
