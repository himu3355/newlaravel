                ...
                <div class="product-infor md:w-1/2 w-full lg:pl-[15px] md:pl-2">
                    <div class="flex justify-between">
                        <div>
                            <div class="product-category caption2 text-secondary font-semibold uppercase">
                                {{ $product_detail->cat_info['title'] }}</div>
                            <div class="product-name heading4 mt-1">{{ $product_detail->title }}</div>
                        </div>
                        <div
                  ...
                  <span class="caption1 text-secondary">(1.234 reviews)</span>
                    ...
                    <div class="flex items-center gap-3 flex-wrap mt-5 pb-6 border-b border-line">
                        ...
                        @endphp
                        <div class="product-price heading5">${{ number_format($after_discount, 2) }}</div>
                    ...
                    <div class="list-action mt-6">
                        ...
                        <div class="more-infor mt-6">
                            <div class="flex items-center gap-1 mt-3">
                                ...
                                <div class="list-category text-secondary">{{ $product_detail->cat_info['title'] }}</div>
                            </div>
                            <div class="flex items-center gap-1 mt-3">
                                <div class="text-title">Stock:</div>
                    ...
                    <div class="desc-item description" data-item="Description">
                        <div class="grid md:grid-cols-2 gap-8 gap-y-5">
                            <div class="left">
                                ...
                                <div class="text-secondary mt-2">
                                    ...
                                    These cabinets not only make a great storage units, but also bring a great decorative
                                    accent to your decor. Traditionally designed, they are perfect to be used in the
                                    hallway, living room, bedroom, office or any place where you need to store or display
                                    things. Made of high quality materials, they are sturdy and durable for years. Bring
                                    one-of-a-kind look to your interior with furniture from Onita Furniture!
                                </div>
                            </div>
                            <div class="right">
                        ...
                        <div class="grid lg:grid-cols-4 grid-cols-2 gap-[30px] md:mt-10 mt-6">
                            <div class="item">
                                ...
                                <div class="text-secondary mt-2">Use on walls, furniture, doors and many more surfaces. The
