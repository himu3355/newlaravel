            ...
            <div class="container">
                <div class="content-main flex justify-between max-xl:flex-col gap-y-8">
                    <div class="xl:w-2/3 xl:pr-3 w-full">
                        <div class="time countdown-cart bg-green py-3 px-5 flex items-center rounded-lg" style="display:none">
                        ...
                        <div class="heading banner mt-5" style="display:none">
                            <div class="text">
                                Buy
                        ...
                        <div class="list-voucher flex items-center gap-5 flex-wrap sm:mt-7 mt-5" style="display:none">
                    ...
                    <div class="xl:w-1/3 xl:pl-12 w-full">
                        <div class="checkout-block bg-surface p-6 rounded-2xl">
                            ...
                            <div class="ship-block py-5 flex justify-between border-b border-line" style="display:none">
